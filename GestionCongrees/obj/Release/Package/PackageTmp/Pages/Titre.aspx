<%@ Page Title="" Language="C#" MasterPageFile="~/Partages/MasterPage.Master" AutoEventWireup="true" CodeBehind="Titre.aspx.cs" Inherits="GestionCongrees.Pages.Titre" %>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Liste des titres</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group"> 
                                                                                        <asp:TextBox ID="NomSearch" runat="server" PlaceHolder="Titre" CssClass="form-control input-sm"></asp:TextBox>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-4">
                                            ...
                                            <div class="col-md-4 margin-bottom-20">
                                                <div class="btn-group">
                                                    <asp:LinkButton ID="addNew" runat="server" OnClick="addNew_Click" CssClass="btn green btn-sm"><i class="fa fa-plus"></i> Ajouter un nouveau titre</asp:LinkButton>
                                                </div>
                                            </div>
