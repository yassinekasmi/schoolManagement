<%@ Page Title="" Language="C#" MasterPageFile="~/Partages/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrganisateurHotel.aspx.cs" Inherits="GestionCongrees.Pages.OrganisateurHotel" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li class="active">Organisateurs Hôtel
                        </li>
                    </ul>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase">Liste des organisateurs des hôtels</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                                                        ...
                                                                        <div class="panel-body ">
                                                                            <div class="row">
                                                                                  <div class="col-md-3">
                                                                                    ...
                                                                                    <asp:DropDownList runat="server" ID="Hotel_Search" CssClass="form-control select2me"></asp:DropDownList>
                                                                                </div>
                                                                                <div class="col-md-3">
                                            ...
                                            <div class="col-md-4 margin-bottom-20">
                                                <asp:LinkButton ID="addNew" runat="server" Visible="false" OnClick="addNew_Click" CssClass="btn green btn-sm"><i class="fa fa-plus"></i> Affecter un organisateur à un Hôtel</asp:LinkButton>
                                            </div>
